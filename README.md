...
```bash
npm i @babel/core@7.x babel-loader@8.x @babel/preset-env@7.x @babel/plugin-transform-runtime@7.x @babel/runtime@7.x babel-plugin-import@1.x -D
```

```bash
npm i @babel/runtime@7.x -S
```
